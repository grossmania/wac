...
# Cognitive Style Differences amogn Experts: Breakdown by dialectical thinking & outsider viewpoint
...
It appears there is a difference in the direction of dialectical experts more likely to mention moral aspirations and meta-cognition, but it is not significant.
...
It appears there is a difference in the direction of dialectical experts *less* likely to mention moral aspirations and meta-cognition, but it is not significant. In fact, both groups are virtually indistinguishable *p* = .870.
...
all.data$moralsQ4<-rowSums(all.data[moralsQ4])
all.data$metacogQ4<-rowSums(all.data[metacogQ4])
all.data$othersQ4<-rowSums(all.data[othersQ4])
...
It appears there is a difference in the direction of dialectical experts being likely to mention moral aspirations and meta-cognition, but it is not significant. 
...
all.data$moralsQ5<-rowSums(all.data[moralsQ5])
all.data$metacogQ5<-rowSums(all.data[metacogQ5])
all.data$othersQ5<-rowSums(all.data[othersQ5])
