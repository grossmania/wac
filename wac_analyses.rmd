...
fig<-ggplot(data.Q13, aes(x=Theme, y=Frequency,color = group, tooltip=group))+
  ...
  xlab("Themes")+geom_hline(yintercept = 0, linetype="dashed", 
    ...
    theme(text = element_text(size = 7.5),legend.title=element_blank(), legend.position="bottom",legend.text=element_text(size=6))
fig
ggplotly(fig, fontsize_row = 10, height = 1020,width = 700,
  fontsize_col = 10)
